            ...
            <div class="card-body">
              <table class="list">
                ...
                <tr v-for="programa in programas">
                  ...
                  <td>
                    <button
                      @click="showingProgramaeditModal = true; selectPrograma(programa)"
                    >Editar</button>
                  </td>
                  <td>
                    <button
                      @click="showingProgramadeleteModal = true; selectPrograma(programa)"
                    >Eliminar</button>
                  </td>
                  <td>
                    <button @click="location='../privilegios.html'">Definir UOCs</button>
                  </td>
                </tr>
              </table>
            </div>
            ...
            <div class="card-body">
              ...
              <table class="list">
                ...
                <tr v-for="rol in roles">
                  ...
                  <td>
                    <button @click="showingRoleditModal = true; selectRol(rol)">Editar</button>
                  </td>
                  <td>
                    <button @click="showingRoldeleteModal = true; selectRol(rol)">Eliminar</button>
                  </td>
                  <td>
                    <button @click="location='../privilegios.html'">Privilegios</button>
                  </td>
                </tr>
              </table>
            </div>
            ...
            <div class="card-body">
              ...
              <table class="list" id="simple">
                ...
                <tr v-for="user in usuarios">
                  ...
                  <td>
                    <button @click="showingdeleteModal = true; selectUser(user)">Eliminar</button>
                  </td>
                </tr>
              </table>
              <div class="fix"></div>
          ...
          <div class="modalcontent">
            <table class="form">
              <tr>
                ...
                <th>:</th>
                <td>
                  <input type="number" placeholder="id" v-model="newUser.id">
                </td>
              </tr>
              <tr>
                <th>Nombre</th>
                <th>:</th>
                <td>
                  <input type="text" placeholder="Nombre" v-model="newUser.nombre">
                </td>
              </tr>
              ...
              <tr>
                ...
                <th>:</th>
                <td>
                  <input type="text" placeholder="apellido" v-model="newUser.apellido">
                </td>
              </tr>
              <tr>
                <th>Correo</th>
                <th>:</th>
                <td>
                  <input type="email" placeholder="correo" v-model="newUser.correo">
                </td>
              </tr>
              <tr>
                <th>Clave</th>
                <th>:</th>
                <td>
                  <input type="text" placeholder="clave" v-model="newUser.clave">
                </td>
              </tr>
              <tr>
                <th>Credencial</th>
                <th>:</th>
                <td>
                  <input type="text" placeholder="credencial" v-model="newUser.credencial">
                </td>
              </tr>
              <tr>
                <th>Lista</th>
                <th>:</th>
                <td>
                  <input type="text" placeholder="lista" v-model="newUser.idlista">
                </td>
              </tr>
              <tr>
                <th>Programa</th>
                <th>:</th>
                <td>
                  <input type="text" placeholder="programa" v-model="newUser.idprograma">
                </td>
              </tr>
            </table>
          ...
          <div class="modalcontent">
            <table class="form">
              <tr>
                ...
                <th>:</th>
                <td>
                  <input type="number" placeholder="id" v-model="newRol.id">
                </td>
              </tr>
              ...
              <tr>
                ...
                <th>:</th>
                <td>
                  <input type="text" placeholder="Nombre" v-model="newRol.nombre">
                </td>
              </tr>
              ...
              <tr>
                ...
                <th>:</th>
                <td>
                  <input type="text" placeholder="descripcion" v-model="newRol.descripcion">
                </td>
              </tr>
            </table>
            <div class="margin"></div>
          ...
          <div class="modalcontent">
            <table class="form">
              <tr>
                ...
                <th>:</th>
                <td>
                  <input type="number" placeholder="id" v-model="newPrograma.id">
                </td>
              </tr>
              <tr>
                <th>Nombre</th>
                <th>:</th>
                <td>
                  <input type="text" placeholder="nombre" v-model="newPrograma.nombre">
                </td>
              </tr>
              <tr>
                <th>facultad</th>
                <th>:</th>
                <td>
                  <input type="text" placeholder="facultad" v-model="newPrograma.facultad">
                </td>
              </tr>
              <tr>
                <th>Snies</th>
                <th>:</th>
                <td>
                  <input type="text" placeholder="snies" v-model="newPrograma.snies">
                </td>
              </tr>
              <tr>
                <th>Duracion</th>
                <th>:</th>
                <td>
                  <input type="number" placeholder="duracion" v-model="newPrograma.duracion">
                </td>
              </tr>
              <tr>
                <th>Modalidad</th>
                <th>:</th>
                <td>
                  <input type="text" placeholder="modalidad" v-model="newPrograma.modalidad">
                </td>
              </tr>
              <tr>
                <th>Reacreditacion</th>
                ...
                <td>
                  <input
                    type="text"
                    placeholder="reacreditacion"
                    v-model="newPrograma.reacreditacion"
                  >
                </td>
              </tr>
              <tr>
                ...
                <th>:</th>
                <td>
                  <input type="text" placeholder="Icfes" v-model="newPrograma.icfes">
                </td>
              </tr>
              <tr>
                <th>Renovacion</th>
                <th>:</th>
                <td>
                  <input type="text" placeholder="Renovacion" v-model="newPrograma.renovacion">
                </td>
              </tr>
              <tr>
                <th>Tipo</th>
                <th>:</th>
                <td>
                  <input type="text" placeholder="Tipo" v-model="newPrograma.tipo">
                </td>
              </tr>
            </table>
            <div class="margin"></div>
          ...
          <div class="modalcontent">
            <table class="form">
              <tr>
                ...
                <th>:</th>
                <td>
                  <input type="text" placeholder="nombre" v-model="clickedUser.nombre">
                </td>
              </tr>
              <tr>
                <th>Apellido</th>
                <th>:</th>
                <td>
                  <input type="text" placeholder="apellido" v-model="clickedUser.apellido">
                </td>
              </tr>
              <tr>
                <th>Correo</th>
                <th>:</th>
                <td>
                  <input type="email" placeholder="correo" v-model="clickedUser.correo">
                </td>
              </tr>
              <tr>
                <th>Clave</th>
                <th>:</th>
                <td>
                  <input type="text" placeholder="clave" v-model="clickedUser.clave">
                </td>
              </tr>
              <tr>
                <th>Credencial</th>
                <th>:</th>
                <td>
                  <input type="text" placeholder="credencial" v-model="clickedUser.credencial">
                </td>
              </tr>
              <tr>
                <th>Lista</th>
                <th>:</th>
                <td>
                  <input type="text" placeholder="lista" v-model="clickedUser.idlista">
                </td>
              </tr>
              <tr>
                <th>Programa</th>
                <th>:</th>
                <td>
                  <input type="text" placeholder="programa" v-model="clickedUser.idprograma">
                </td>
              </tr>
            </table>
            <div class="margin"></div>
          ...
          <div class="modalcontent">
            <table class="form">
              <tr>
                ...
                <th>:</th>
                <td>
                  <input type="text" placeholder="nombre" v-model="clickedRol.nombre">
                </td>
              </tr>
              <tr>
                <th>Descripción</th>
                <th>:</th>
                <td>
                  <input type="text" placeholder="descripcion" v-model="clickedRol.descripcion">
                </td>
              </tr>
            </table>
            <div class="margin"></div>
          ...
          <div class="modalcontent">
            <table class="form">
              <tr>
                ...
                <th>:</th>
                <td>
                  <input type="text" placeholder="nombre" v-model="clickedPrograma.nombre">
                </td>
              </tr>
              <tr>
                <th>facultad</th>
                <th>:</th>
                <td>
                  <input type="text" placeholder="facultad" v-model="clickedPrograma.facultad">
                </td>
              </tr>
              <tr>
                <th>Snies</th>
                <th>:</th>
                <td>
                  <input type="text" placeholder="snies" v-model="clickedPrograma.snies">
                </td>
              </tr>
              <tr>
                <th>Duracion</th>
                <th>:</th>
                <td>
                  <input type="number" placeholder="duracion" v-model="clickedPrograma.duracion">
                </td>
              </tr>
              <tr>
                <th>Modalidad</th>
                <th>:</th>
                <td>
                  <input type="text" placeholder="modalidad" v-model="clickedPrograma.modalidad">
                </td>
              </tr>
              <tr>
                <th>Reacreditacion</th>
                ...
                <td>
                  <input
                    type="text"
                    placeholder="reacreditacion"
                    v-model="clickedPrograma.reacreditacion"
                  >
                </td>
              </tr>
              <tr>
                ...
                <th>:</th>
                <td>
                  <input type="text" placeholder="Icfes" v-model="clickedPrograma.icfes">
                </td>
              </tr>
              <tr>
                <th>Renovacion</th>
                <th>:</th>
                <td>
                  <input type="text" placeholder="Renovacion" v-model="clickedPrograma.renovacion">
                </td>
              </tr>
              <tr>
                <th>Tipo</th>
                <th>:</th>
                <td>
                  <input type="text" placeholder="Tipo" v-model="clickedPrograma.tipo">
                </td>
              </tr>
            </table>
            <div class="margin"></div>
            <button
              class="center"
              @click="showingProgramaeditModal = false;updatePrograma() "
            >ACEPTAR</button>
            <div class="margin"></div>
          </div>
        </div>
        ...
        <div class="modalbody">
          <div class="modalcontent">
            ...
            <h3 class="center">
              ...
              Este rol se eliminará de todos los usuarios que lo contengan
            </h3>
            <div class="margin"></div>
        ...
        <div class="modalbody">
          <div class="modalcontent">
            ...
            <h3 class="center">
              ...
              Este programa se eliminará con todos los usuarios que lo contengan
            </h3>
            <div class="margin"></div>
...
export default {
  ...
  methods: {
    ...
    getAllU: function() {
      var that = this;
      axios
        .get("http://localhost/Software/api.php?action=readusers")
    ...
    getOneUser: function() {
      ...
      axios
        .get("http://localhost/Software/api.php?action=search", {
          params: {
            id: that.id
          }
        })
    ...
    getProgramasFacultad: function() {
      ...
      //console.log("Al menos entra +" + formData)
      axios
        .get("http://localhost/Software/api.php?action=getProgramasFacultad", {
          params: {
    ...
    getFacultad: function() {
      ...
      //console.log("Al menos entra +" + formData)
      axios
        .get("http://localhost/Software/api.php?action=getFacultad", {
          params: {
            facultad: that.facultad
          }
        })
    ...
    getPrograma: function() {
      ...
      //console.log("Al menos entra +" + formData)
      axios
        .get("http://localhost/Software/api.php?action=getPrograma", {
          params: {
    ...
    getAllRoles: function() {
      ...
      axios
        .get("http://localhost/Software/api.php?action=readrol")
        .then(function(response) {
          console.log(response.data);
          if (response.data.error) {
    ...
    saveUser: function() {
      ...
      axios
        .post("http://localhost/Software/api.php?action=createuser", formData)
        .then(function(response) {
    ...
    saveRol: function() {
      ...
      axios
        .post("http://localhost/Software/api.php?action=createrol", formData)
        .then(function(response) {
          console.log(response);
    ...
    savePrograma: function() {
      ...
      axios
        .post(
          "http://localhost/Software/api.php?action=saveProgramaFacultad",
          formData
        )
        .then(function(response) {
          console.log(response);
    ...
    updateUser: function() {
      ...
      var formData = that.toFormData(that.clickedUser);
      axios
        .post("http://localhost/Software/api.php?action=updateuser", formData)
        .then(function(response) {
          console.log(response);
          that.clickedUser = {};
          if (response.data.error) {
    ...
    updatePrograma: function() {
      ...
      axios
        .post(
          "http://localhost/Software/api.php?action=updateProgramasFacultad",
          formData
        )
        .then(function(response) {
          console.log(response);
    ...
    updateRol: function() {
      ...
      axios
        .post("http://localhost/Software/api.php?action=updaterol", formData)
        .then(function(response) {
          that.clickedRol = {};
          if (response.data.error) {
            that.errorRolMessage = response.data.message;
    ...
    deleteUser: function() {
      ...
      var formData = that.toFormData(that.clickedUser);
      axios
        .post("http://localhost/Software/api.php?action=deleteuser", formData)
        .then(function(response) {
          that.clickedUser = {};
          if (response.data.error) {
            that.errorUserMessage = response.data.message;
    ...
    deletePrograma: function() {
      ...
      axios
        .post(
          "http://localhost/Software/api.php?action=deletePrograma",
          formData
        )
        .then(function(response) {
          console.log(response);
    ...
    deleteRol: function() {
      ...
      var formData = that.toFormData(that.clickedRol);
      axios
        .post("http://localhost/Software/api.php?action=deleterol", formData)
        .then(function(response) {
          console.log(response);
          that.clickedRol = {};
          if (response.data.error) {
